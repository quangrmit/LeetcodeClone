    ...
    public class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Testcase>().HasData(
                ...
                new Testcase { TestcaseId = 2, QuestionId = 2, funcName = "twoSum", cases = "{\"data\":[{\"input\": \"2 7 11 15 9 # 0 1\", \"output\": \"[0,1]\"}, {\"input\": \"3 2 4 6 # 0 1\", \"output\": \"[0,1]\"}, {\"input\": \"3 3 6 # 0 1d\", \"output\": \"[0,1]\"}] }" }
             );
        }
    }
}
